    ...
    <section className="projects">
        ...
        <Wrap>
            <div className="projects__content">
                ...
                <Accordion title="News App" service="Frontend Development" num="7" link="https://github.com/petramarkovic/news" desc="Example of a React News app. Created with React framework and typescript using News API." img="newz.jpg" alt="News App"/>
            </div>
        </Wrap>
    </section>
  )
